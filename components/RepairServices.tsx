...
import { Smartphone, Tablet, Laptop, ArrowRight, CheckCircle, Clock, Shield, Star, Camera, RefreshCw, Wrench  } from "lucide-react"
import Link from "next/link"
import { Monitor, Battery, Cpu, HardDrive, Droplets, Zap } from "lucide-react"
...
export default function RepairServices() {
  ...
  className="bg-white dark:bg-gray-800 border border-slate-200 dark:border-gray-700 rounded-xl p-4 hover:shadow-lg transition-all duration-300 hover:border-pink-300 dark:hover:border-pink-600 text-center group"
>
  <Camera className="w-8 h-8 text-pink-600 mx-auto mb-2 group-hover:scale-110 transition-transform" />
  <span className="text-sm font-medium text-slate-800 dark:text-gray-100">Kamera Değişimi</span>
</Link>

<Link
  href="/yazilim-guncelleme"
  className="bg-white dark:bg-gray-800 border border-slate-200 dark:border-gray-700 rounded-xl p-4 hover:shadow-lg transition-all duration-300 hover:border-yellow-300 dark:hover:border-yellow-600 text-center group"
>
  <RefreshCw className="w-8 h-8 text-yellow-600 mx-auto mb-2 group-hover:scale-110 transition-transform" />
  <span className="text-sm font-medium text-slate-800 dark:text-gray-100">Yazılım Güncelleme</span>
</Link>

<Link
  href="/arka-cam-degisimi"
  className="bg-white dark:bg-gray-800 border border-slate-200 dark:border-gray-700 rounded-xl p-4 hover:shadow-lg transition-all duration-300 hover:border-red-300 dark:hover:border-red-600 text-center group"
>
  <Wrench className="w-8 h-8 text-red-600 mx-auto mb-2 group-hover:scale-110 transition-transform" />
  <span className="text-sm font-medium text-slate-800 dark:text-gray-100">Arka Cam Değişimi (Lazerli)</span>
</Link>
